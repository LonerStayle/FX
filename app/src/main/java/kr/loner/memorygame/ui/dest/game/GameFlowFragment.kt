...
import kr.loner.memorygame.databinding.FragmentGameFlowBinding
import kr.loner.memorygame.db.entity.GameModel
import kr.loner.memorygame.ui.adapter.GameAdapter
import kr.loner.memorygame.ui.base.BaseFragment
import kr.loner.memorygame.ui.util.Contents
import kr.loner.memorygame.ui.util.Contents.startRound
...
class GameFlowFragment : BaseFragment<FragmentGameFlowBinding>(
    ...
    private fun FragmentGameFlowBinding.gameInProgress() {
        tvInfo.text = requireActivity().resources.getString(R.string.tv_find)
